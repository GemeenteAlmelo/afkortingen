...
<dt>BIV</dt> 
<dd>Beschikbaar Integriteit Vertrouwelijkheid</dd>
<dt>BKWI</dt> 
<dd>Bureau Keteninformatisering Werk en Inkomen</dd>
<dt>BOR</dt> 
<dd>Basis Object Registratie</dd>
<dt>BOR</dt> 
<dd>Beheer Openbare Ruimte</dd>
<dt>Bor</dt> 
<dd>Besluit omgevingsrecht</dd>
<dt>BORIUS</dt> 
...
<dt>DLP</dt>
<dd>Data Leak(/loss) Protection</dd>
<dt>DMARC</dt>
<dd>Domain-based Message Authentication Reporting</dd>
<dt>DML</dt>
...
<dt>GGI</dt>
<dd>Gemeentelijke Gemeenschappelijke Architectuur</dd>
<dt>GI</dt>
...
<dt>OTAP</dt>
<dd>Ontwikkel Test Acceptatie Productie</dd>
</dl>
...
<dt>PKI</dt>
<dd>Public Key Infrastructuur</dd>
<dt>PSA</dt>
...
<dt>SFTP</dt>
<dd>Secure File Transfer Protocol</dd>
<dt>SIEM</dt>
<dd>Security Information & Event Management</dd>
<dt>SLA</dt>
...
<dt>VLAN</dt>
<dd>Virtueel Local Area Network</dd>
<dt>VNG</dt>
